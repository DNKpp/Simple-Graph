...
namespace sl::graph::dfs
{
	/** \addtogroup dfs
	* @{
	* \brief Provides the search_params and other related things modeling the depth first search algorithm.
	*/
	...
	struct search_params
	{
		 ...
		 * open list should model the behaviour of a stack-like container. Otherwise this results in undefined behaviour.
		 */
		TOpenList openList{};
	};
